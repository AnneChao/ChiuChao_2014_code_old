#===========================================================================================
#
# Empirical functional diversity and functional alpha, beta, gamma diversity and similarity
#
# input:
...
#===========================================================================================
#
# Empirical pairwise similarity indices for CqN and UqN similarity indices
#
# input:
...
dij <- as.matrix(dij)
Func2014(Dis = dij, abun = data, q = 0)
pairFunc(Dis = dij, abun = data, q = 0)
